...
Internal placeholder package generated by Yokai.
`;
  ...
  writeFileSync(join(pkgDir, "README.md"), readmeContent);
...
Return JSON matching this schema:
{
  ...
  let readmeContent = `# ${token.packageName}
    ...
    for await (const msg of runtime.query({
      ...
      if (msg.type === "result" && msg.subtype === "success") {
        ...
        if (output) {
          ...
          readmeContent = output.readmeContent ?? readmeContent;
        }
      }
    }
  } catch (err) {
